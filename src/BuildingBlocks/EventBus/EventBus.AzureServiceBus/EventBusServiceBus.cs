...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            SubsManager.AddSubsription<T, TH>();
        }
        ...
        public override void UnSubscribe<T, TH>()
        {
            ...
            {
                logger.LogWarning("The messaging ebtity {eventName] could not be found",eventName);
            }

            logger.LogInformation("Unsubscribing from event {EventName}",eventName);

            SubsManager.RemoveSubsription<T,TH>();
        }
        ...
        private Task ExceptionReceivedHandler(ExceptionReceivedEventArgs exceptionReceivedEventArgs)
        {
            ...
            logger.LogError(ex, "Error handlig message : {ExceptionMessage} - Context: {@ExceptionContext}", ex.Message, context);
